...
class ActorUser(models.Model):
    ...
    user = models.ForeignKey(UserInfo,verbose_name=u'处理人',blank=True,null=True)
...
class Item(models.Model):
    ...
    route = models.ForeignKey(Route,verbose_name=u'所属流程',blank=True,null=True)
    user = models.ForeignKey(UserInfo,verbose_name=u'项目申请人',blank=True,null=True)
...
class TaskHistory(models.Model):
    ...
    user = models.ForeignKey(UserInfo,verbose_name=u'审批人',blank=True,null=True)
