...
class ProjectSetting(models.Model):
    ...
    before_2015_amount = models.DecimalField(u'2015年之前已采购金额',max_digits = 15, decimal_places=2, blank=True, null=True)
...
class VendorSetting(models.Model):
    ...
    before_2014_owed_amount = models.DecimalField(u'2014年底前欠款',max_digits = 15, decimal_places=2, blank=True, null=True)
    before_2014_owed_invoice = models.DecimalField(u'2014年底前欠发票',max_digits = 15, decimal_places=2, blank=True, null=True)
