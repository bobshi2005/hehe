...
from hehe.constant import MAX_PROJECT_MATERIAL_QANTITY, format_decimal_number
...
class Order(models.Model):
    ...
    user = models.ForeignKey(UserInfo,verbose_name=u'采购人', limit_choices_to = {'groups__name' : u'采购部门'}, blank=True, null=True)
...
class OrderLine(models.Model):
    ...
    purchase_quantity = models.DecimalField(u'采购数量',max_digits = 15, decimal_places=2,blank=True,null=True)
    ...
    def getQuantity(self):
        ...
        return format_decimal_number(qunatity)
    
    getQuantity.short_description = u"预算量"
    
    def getExpectedQuantity(self):
        return format_decimal_number(self.documentLineItem.expected_quantity)
    getExpectedQuantity.short_description = u"要求量"
    
    def getAuditQuantity(self):
        return format_decimal_number(self.documentLineItem.audit_quantity or '')
    ...
    def getPostedQuantity(self):
        ...
        return format_decimal_number(total_quantity['receiving_quantity__sum'] or 0)
    ...
    def getTotalPurchasedQuantity(self):
        ...
        return format_decimal_number(total_quantity['purchase_quantity__sum'] or '')
...
class ReceivingLine(models.Model):
    ...
    def getPurchaseQuantity(self):
        return format_decimal_number(self.orderLine.purchase_quantity)
...
class Invoice(models.Model):
    ...
    user = models.ForeignKey(UserInfo,verbose_name=u'经手人', limit_choices_to = {'groups__name' : u'采购部门'})
