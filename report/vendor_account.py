...
def getOwedAmountByYear(year, month, vendor, company):
    ...
    if year == 2014:
        ...
        receiving_total = getTotalReceiving(year, month, vendor, company)
    ...
    payment_amount = getTotalPayment(year, month, vendor, company)
...
def getOwedInvoiceByYear(year, month, vendor, company):
    ...
    invoice_total = getTotalInvoice(year, month, vendor, company)
...
def getTotalInvoice(year, month, vendor, company):
    start_date = get_first_date_of_month(2015, 1)
    end_date = get_last_date_of_month(year, month)
    return getTotalInvoiceByDate(start_date, end_date, vendor, company)
...
def getTotalInvoiceByDate(start_date, end_date, vendor, company):
    args_list = [] 
    if vendor: 
...
#2015 开始到当前月 所有的发货
def getTotalReceiving(year, month, vendor, company):
    start_date = get_first_date_of_month(2015, 1)
    end_date = get_last_date_of_month(year, month)
    return getTotalReceivingByDate(start_date, end_date, vendor, company)
...
def getTotalReceivingByDate(start_date, end_date, vendor, company):
...
#2015 开始到当前月 所有的已付款
def getTotalPayment(year, month, vendor, company):
    start_date = get_first_date_of_month(2015, 1)
    end_date = get_last_date_of_month(year, month)
    return getTotalPaymentByDate(start_date, end_date, vendor, company)
...
def getTotalPaymentByDate(start_date, end_date, vendor, company):
    args_list = [] 
    if vendor: 
        args_list.append(Q(vendor = vendor))
    if company:
